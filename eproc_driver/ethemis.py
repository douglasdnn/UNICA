...
#vai até a tela de login
    driver.get("https://ethemis1g.tjrs.jus.br/ethemis1g/res-plc/login/loginPlc.html")
    time.sleep(tempo)    

#preenche a tela de login
    driver.find_element(By.ID, "loginUsuario").click()
    time.sleep(tempo)
    driver.find_element(By.ID, "loginUsuario").send_keys(usuario)
    time.sleep(tempo)
    driver.find_element(By.ID, "loginSenha").click()
    time.sleep(tempo)
    driver.find_element(By.ID, "loginSenha").send_keys(senha)
    time.sleep(tempo)
    driver.find_element(By.ID, "loginSenha").send_keys(Keys.ENTER)
    time.sleep(tempo+5)
